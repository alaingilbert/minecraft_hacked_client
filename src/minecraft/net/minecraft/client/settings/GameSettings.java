...
public class GameSettings
{
    ...
    public KeyBinding keyBindFreeCam = new KeyBinding("Freecam", Keyboard.KEY_U, "Manticore");
    ...
    public KeyBinding keyBindXRay = new KeyBinding("X-ray", Keyboard.KEY_X, "Manticore");
    public KeyBinding keyBindChestESP = new KeyBinding("Chest ESP", Keyboard.KEY_N, "Manticore");
    ...
    public KeyBinding field_193630_aq = new KeyBinding("key.loadToolbarActivator", Keyboard.KEY_Z, "key.categories.creative");
    ...
    {
        this.keyBindings = (KeyBinding[])ArrayUtils.addAll(new KeyBinding[] {this.keyBindFreeCam, this.keyBindKillAura, this.keyBindClickAura, this.keyBindBreadcrumb, this.keyBindGPS, this.keyBindChestESP, this.keyBindXRay, this.keyBindLight, this.keyBindAttack, this.keyBindUseItem, this.keyBindForward, this.keyBindLeft, this.keyBindBack, this.keyBindRight, this.keyBindJump, this.keyBindSneak, this.keyBindSprint, this.keyBindDrop, this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand, this.keyBindScreenshot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindFullscreen, this.keyBindSpectatorOutlines, this.keyBindSwapHands, this.field_193629_ap, this.field_193630_aq, this.field_194146_ao}, this.keyBindsHotbar);
